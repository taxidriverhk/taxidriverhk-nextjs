    ...
    <Template activeWebsite={Website.PERSONAL} path={currentPath}>
      ...
      <PersonalSection
        ...
        items={[
          {
            description:
              "An entirely client-based tool to estimate dividend income of a given portfolio using publicly available API. Code is mostly generated by ChatGPT with minor fine tunes.",
            href: `${currentPath}/passive-income`,
            icon: faChartLine,
